...
case "${FIXTURE_EXTENSION_LOWER}" in
  txt)      PRELOAD_FORMAT="txt" ;;
  md|markdown) PRELOAD_FORMAT="markdown" ;;
  rtf)      PRELOAD_FORMAT="rtf" ;;
  docx)     PRELOAD_FORMAT="docx" ;;
  html|htm) PRELOAD_FORMAT="html" ;;
  epub)     PRELOAD_FORMAT="epub" ;;
  pdf)      PRELOAD_FORMAT="pdf" ;;
  *)
...
LAUNCH_ENV+=(
  "DEVICECTL_CHILD_POSEY_PRELOAD_FORMAT=${PRELOAD_FORMAT}"
  "DEVICECTL_CHILD_POSEY_PRELOAD_TITLE=${FIXTURE_STEM}"
  "DEVICECTL_CHILD_POSEY_PRELOAD_FILENAME=${FIXTURE_NAME}"
  "DEVICECTL_CHILD_POSEY_PRELOAD_INLINE_BASE64=${FIXTURE_BASE64}"
)
